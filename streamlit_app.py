...
def main():
    ...
    analysis_type = st.sidebar.selectbox('Select Analysis Type', ['Line Utilization', 'Demand Fulfillment'])
    
    if analysis_type == 'Line Utilization':
        line_number = st.sidebar.selectbox('Select Line Number', utilization_df['Line'].unique())
        overall_or_monthly = st.sidebar.radio('Select View', ['Monthly Utilization', 'Overall Utilization'])
        
        if overall_or_monthly == 'Monthly Utilization':
        ...
        elif overall_or_monthly == 'Overall Utilization':
        ...
        products = st.sidebar.multiselect('Select Product(s)', demand_df['Product'].unique(), default=demand_df['Product'].unique())
        overall_or_monthly = st.sidebar.radio('Select View', ['Monthly Fulfillment', 'Overall Fulfillment'])
        
        if overall_or_monthly == 'Monthly Fulfillment':
            with st.spinner('Updating Dashboard...'):
        ...
        elif overall_or_monthly == 'Overall Fulfillment':
